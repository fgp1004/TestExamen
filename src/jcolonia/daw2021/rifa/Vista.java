...
public abstract class Vista {
	...
	public final void mostrarTítulo1() {
		String líneaSubrayado = hacerSubrayado(título.length() + 2, '=');
		out.println("\n" + líneaSubrayado + "\n " + título + "\n" + líneaSubrayado);
	}
	// + getTítulo(): String
	...
	public final void mostrarTítulo2() {
		String líneaSubrayado = hacerSubrayado(título.length(), '-');
		out.println("\n" + título + "\n" + líneaSubrayado);
	}
	// + mostrarTítulo2(): void
...
//	+ {static} mostrarAviso(texto: String): void
	 ...
	 */
	public final static String hacerSubrayado(int tamaño, char símbolo) {
		String resultado;
		char[] línea;
